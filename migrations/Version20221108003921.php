 ...
 */
final class Version20221108003921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clients (id INT NOT NULL, name VARCHAR(32) NOT NULL, doc INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE phones (id INT NOT NULL, number INT NOT NULL, PRIMARY KEY(id))');
    }
